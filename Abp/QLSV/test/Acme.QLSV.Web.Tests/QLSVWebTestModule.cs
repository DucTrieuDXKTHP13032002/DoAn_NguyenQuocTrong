...
[DependsOn(
    ...
    typeof(QLSVWebModule),
    typeof(QLSVApplicationTestModule),
    typeof(QLSVEntityFrameworkCoreTestModule)
)]
public class QLSVWebTestModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            builder.PartManager.ApplicationParts.Add(new CompiledRazorAssemblyPart(typeof(QLSVWebModule).Assembly));
        });
